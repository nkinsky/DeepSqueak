...
% Get the data
[ClusteringData, clustAssign] = CreateClusteringData(handles.data, 1);
...
ClusteringData.embedY = embed(:,1);
ClusteringData.embedX = embed(:,2);
ClusteringData(:,10) = num2cell(embed(:,1));
ClusteringData(:,11) = num2cell(embed(:,2));
...
calls2plot = datasample(ClusteringData, NumberOfCalls, 1,'Replace',false);
